...
public class MyConfiguration {
    ...
    public CommandLineRunner getRuner(SinhVienDAOImpl sinhVienDAOImpl) {
        return runner -> {
            ...
            while (true) {
                ...
                else if (choice==7) deleteMot(sinhVienDAOImpl,sc);
                else if (choice==8) deleteNhieu(sinhVienDAOImpl,sc);
                else break;
            }
        };
    }
    ...
    public void menu(){
        ...
        System.out.println("7. deleteMot");
        System.out.println("8. deleteNhieu");
...
//      else list.forEach(sv->System.out.println(sv)); nó giống cái này
    ...
    public void deleteMot(SinhVienDAOImpl sinhVienDAOImpl, Scanner sc){
        System.out.println("Nhập id cần xóa");
        int id = sc.nextInt();
        sinhVienDAOImpl.delete(id);
    }

    public void deleteNhieu(SinhVienDAOImpl sinhVienDAOImpl, Scanner sc){
